...
function() {
    function e() {
        ...
        function c(e) {
            if (e.target && (e.target.closest("a.js-click-stat") || e.target.closest(".js-click-zero-stat"))) {
    ...
    Tilda.sendEcommerceEvent = function(e, t) {
        ...
        if (void 0 === e || "add" !== e && "remove" !== e && "purchase" !== e && "detail" !== e)
            return !1;
        for (var r, a = "", i = 0, d = [], c, o, n = "", m = "", l = "", u = 0; u < t.length; u++) {
            a > "" && (a += ", "),
            a += (o = t[u]).name,
            i += o.price,
            c = "",
            void 0 !== o.options && o.options.length > 0 && Array.prototype.forEach.call(o.options, (function(e) {
    ...
    Tilda.sendEventToStatistics = function(e, t, r, a) {
        var i = "/" === e.substring(0, 1),
            ...
            c,
            o;
        (c = document.getElementById("allrecords")) && (o = null !== c.getAttribute("data-fb-event") ? c.getAttribute("data-fb-event") : window.jQuery && void 0 !== $("#allrecords").data("fb-event") ? $("#allrecords").data("fb-event") : null);
        var n = !(!o || "nosend" !== o),
            m = c ? c.getAttribute("data-vk-event") : null;
        c && (m = null !== c.getAttribute("data-vk-event") ? c.getAttribute("data-vk-event") : window.jQuery && void 0 !== $("#allrecords").data("vk-event") ? $("#allrecords").data("vk-event") : null);
        var l = !(!m || "nosend" !== m),
            u = "",
            s = document.querySelector(".t706");
        if (u = c.getAttribute("data-tilda-currency") ? c.getAttribute("data-tilda-currency") : s && s.getAttribute("data-project-currency-code") ? s.getAttribute("data-project-currency-code") : "RUB", r || (r = window.location.href), (a = a ? parseFloat(a) : 0) > 0)
            if (window.dataLayer || (window.dataLayer = []), -1 !== e.indexOf("/tilda/") && -1 !== e.indexOf("/payment/") && window.tildaForm && window.tildaForm.orderIdForStat > "")
                ...
                for (var p = 0; p < d.length; p++)
                    d[p].id || (d[p].sku ? d[p].id = d[p].sku : d[p].uid ? d[p].id = d[p].uid : d[p].recid && d[p].lid && (d[p].id = d[p].recid + "_" + d[p].lid));
        ...
        try {
            ...
            if (window.gtagTrackerID && "gtag" === window.mainTracker)
                if (i)
                    if (r && r.event)
                        if ("purchase" === r.event) {
                            for (var d = r.ecommerce.purchase.products, w = 0, g = 0; g < d.length; g++)
                                if ("delivery" === d[g].id) {
                                    w = d[g];
                                    break
                                }
            ...
            try {
                if (i)
                    if (-1 === e.indexOf("tilda/") || -1 === e.indexOf("/payment/") && -1 === e.indexOf("/submitted/"))
                        ...
                        a > 0 && u ? window.fbq("track", "InitiateCheckout", {
                            content_name: t,
                            content_category: e,
                            value: a,
                            currency: u
            ...
            try {
                if (i) {
                    ...
                    if (r && r.event)
                        ...
                        T = "t-purchase-" + (F = (F = (F = e.replace("/tilda/", "")).replace("tilda/", "")).replace("/payment/", ""));
                    else if (-1 !== e.indexOf("tilda/") && -1 !== e.indexOf("/submitted/"))
                        T = "t-lead-" + (F = (F = (F = e.replace("/tilda/", "")).replace("tilda/", "")).replace("/submitted/", ""));
        ...
        try {
            ...
            if (-1 !== e.toLowerCase().indexOf("utm_") && "string" == typeof (t = (t = (e = e.toLowerCase()).split("?"))[1])) {
                var a,
                    i = t.split("&");
                for (var d in i)
                    "amp;" === (a = i[d].split("="))[0].substring(0, 4) && (a[0] = a[0].substring(4)),
