...
urlpatterns = [
    ...
    path('result/1', views.result1),
    # path('result/2', views.result2),
    # path('result/3', views.result3),
    # path('result/4', views.result4),
    # path('result/5', views.result5),
    # path('result/6', views.result6),
    # path('result/7', views.result7),
    # path('result/8', views.result8),
